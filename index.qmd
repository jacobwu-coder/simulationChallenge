...
In this particular simulation run, the coin landed heads **`{python} n_heads`** times and tails **`{python} n_tails`** times out of 50 flips — almost exactly 50/50. Yet the final account balance is **$`{python} f"{round(final_balance, 0):,.0f}"`**.
...
fig.suptitle('Comparing Investment Strategies over 50 Years', fontsize=14, fontweight='bold', y=1.01)
fig.tight_layout()
plt.show()
```
